...
(custom-set-variables
 ...
 '(erc-modules (quote (completion scrolltobottom stamp truncate hl-nicks netsplit fill button match track readonly networks ring autojoin noncommands irccontrols move-to-prompt menu list)))

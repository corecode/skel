...
(defun color-theme-2c ()
  ...
  (color-theme-install
   '(color-theme-2c
     ...
     (completions-common-part ((t (:width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "White" :background "black" :stipple nil)))
     ...
     (menu ((t (nil))))
     (minibuffer-depth-indicator ((t (:family "DejaVu Sans Mono" :foundry "unknown" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "White" :background "black" :stipple nil :height 98))))
